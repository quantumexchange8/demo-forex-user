...
return [
    ...
    "download_center_header_title" => "Start Your Brokerage Business With cTrader",
    "download_center_header_message" => "cTrader is a complete trading platform solution for Forex and CFD brokers to offer their traders. The platform offers a wide variety of options to accommodate all potential investing preferences.",
    "download_section_header" => "Download Now",
    "download_section_message" => "Get started with the powerful trading platform designed for professionals. Download cTrader today!",
