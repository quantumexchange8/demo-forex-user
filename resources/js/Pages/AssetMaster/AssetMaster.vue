    ...
    <AuthenticatedLayout :title="$t('public.asset_master')">
        <div class="flex flex-col items-center gap-5 self-stretch">
            ...
            <div class="relative flex flex-col items-center gap-5 w-full h-full">
                <!-- Banner Image -->
                <a href="https://currenttech.pro/" target="blank" class="w-full h-full">
                ...
                <div class="absolute top-[28%] left-[4%]">
                    ...
                    <div class="absolute bottom-[9%] left-[7%] font-semibold text-white text-[4px] md:text-[9px] xl:text-[12px] 3xl:text-[18px]">
                        currenttech.pro
                    </div>
                </a>
            </div>
