export default {
    ...
    column: {
        headerCell: ({ context, props }) => ({
            class: [
                ...
                // Color
                (props.sortable === '' || props.sortable) && context.sorted ? 'bg-highlight' : 'bg-white text-gray-700',
                'border-gray-200',
        ...
        sort: ({ context }) => ({
            class: [context.sorted ? 'text-primary-500' : 'text-gray-700']
        }),
        ...
        sortIcon: ({ context }) => ({
            class: ['ml-2', context.sorted ? 'text-inherit' : 'text-gray-700']
        }),
        columnFilter: {
    ...
    bodyRow: ({ context, props }) => ({
        class: [
            ...
            { 'hover:bg-gray-300/20 hover:text-gray-600': props.selectionMode && !context.selected },
